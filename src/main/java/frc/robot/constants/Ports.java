...
public class Ports {
  ...
  public static final int ShooterMotorMain = 5;
  public static final int ShooterMotorSub = 6;
  ...
  public static final int LeftHangCAN = 11;
  ...
  public static final int hangpistonport = 1;
